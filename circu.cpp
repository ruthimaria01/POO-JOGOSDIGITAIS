	...
	*/
	...
	while (!sair)
	{
		...
		else
		{
			...
			cout << "<DIGITE TERCERO NUMERO DO CODIGO NO TERMINAL> ";
			cin >> codigo;
...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	// if e o else tem a funcao de mandar execultar todos os if's e caso precise os else's, imprimindo o que for de acordo com a condicao;
	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
		cout << "	      |||||    " << endl;
